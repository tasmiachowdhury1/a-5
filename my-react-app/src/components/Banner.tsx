            ...
            <div className='container mx-auto justify-between flex items-center'>
                <div className="flex flex-col gap-9">
                    <div className="flex flex-col gap-7" ><h1 className="text-6xl font-bold">
                        Build Your Ideal <br /> <span className="bg-linear-to-r from-orange-500 via-pink-600 to-purple-600 bg-clip-text text-transparent">Development Stack</span>
                    </h1>
                        <p className="w-120 text-[17px] text-gray-600">Explore frontend, backend, database, and tooling options,
                            compare them side by side, and put together the stack that fits your
                            next project.</p></div>
                    <div className="flex gap-3"><button className="cursor-pointer bg-linear-to-r from-orange-500 to-pink-600 text-gray-50 p-2 rounded-sm">Explore Technologies</button>
